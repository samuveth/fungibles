...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    IHiEllipsisVerticalSolid: typeof import('~icons/heroicons/ellipsis-vertical-solid')['default']
    ...
    IHiInformationCircleSolid: typeof import('~icons/heroicons/information-circle-solid')['default']
    IHiXMark20Solid: typeof import('~icons/heroicons/x-mark20-solid')['default']
    IIconGithub: typeof import('~icons/icon/github')['default']
    IIconHelpCircle: typeof import('~icons/icon/help-circle')['default']
    IIconMenu: typeof import('~icons/icon/menu')['default']
